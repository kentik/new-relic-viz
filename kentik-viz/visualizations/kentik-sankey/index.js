...
export default class SankeyVisualization extends React.Component {
  ...
  static propTypes = {
     ...
     * Chart Name
     */
    chartName: PropTypes.string.optional,
  ...
  render() {
    const { chartName, dimensionLeft, dimensionRight, showTable, nrqlQueries } = this.props;
          ...
          {({ width, height }) => (
            ...
            >
              {({ data, loading, error }) => {
                ...
                return (
                  <Card>
                    {this.renderSankey(data, width, showTable ? height - 196 : height)}
  ...
  <Card className="EmptyState">
    <CardBody className="EmptyState-cardBody">
      ...
      >
        ...
        &amp; account ID pair.
        <br />
        Your NRQL should include both dimensions, `bits/s_in`, `bits/s_out` and
        sample_rate.
      </HeadingText>
      <HeadingText
